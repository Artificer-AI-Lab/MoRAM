...
def create_hf_model(model_class,
    ...
    model = model_class.from_pretrained(
        ...
        attn_implementation="sdpa"  # Use PyTorch's Scaled Dot Product Attention for speed
    )
    print(f"\033[34mModel loaded with attention implementation: {model.config._attn_implementation}\033[0m")
