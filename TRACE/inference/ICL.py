...
# Qwen3-specific prompt suffixes for standardized output format
QWEN3_MCQ_SUFFIX = '\nPlease show your choice in the answer field with only the choice letter, e.g., {"answer": "C"}.'
QWEN3_MATH_SUFFIX = '\nPlease reason step by step, and put your final answer within \\boxed{}.'

# Tasks that use multiple-choice format
MCQ_TASKS = {"FOMC", "C-STANCE", "ScienceQA", "BoolQA", "QQP", "amazon", "yelp", "agnews", "dbpedia", "yahoo", 
             "MNLI", "RTE", "SST-2", "WiC", "CB", "MultiRC", "IMDB", "NIL"}
# Tasks that use math format
MATH_TASKS = {"NumGLUE-cm", "NumGLUE-ds"}
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=4096,
        help="Max prompt tokens for MeetingBank inference.",
    )
    parser.add_argument(
        "--temperature",
        type=float,
